...
def build_html(name, author, description, license, folder):
    ...
    </head>""" + f"""<body><a href='..'>Back to Home</a><h1>{name}</h1><h4>by {author}<hr></h4><p>{description}</p><script type="text/javascript" src="https://cdn.jsdelivr.net/npm/toastify-js"></script><button style='position: absolute; bottom: 5px;' onclick='copyLink()'>Add to Cumcord</button></body>"""
